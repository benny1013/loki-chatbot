...
def getReply(utterance, args):
    try:
        # 檢查 utterance 中是否包含"活動"
        has_activity_1 = any("活" in i for i in utterance)
        has_activity_2 = any("動" in i for i in utterance)
        
        if has_activity_1 and has_activity_2:
            # 爬取系網活動資訊
...
if __name__ == "__main__":
    ...
    resultDICT = getResult("上學期大學部有哪些課程", "[上學期][大學部]有哪些課程", [], {}, {})
    pprint(resultDICT)